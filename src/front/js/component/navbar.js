					...
					<ul className="navbar-nav ms-auto mb-2 mb-lg-0">
						<li className="nav-item">
							<Link to="/dashboard" className="decoration">	
								<span className="nav-link sidebar-link" aria-current="page">Dashboard</span>
							</Link>
						</li>
						<li className="nav-item">
							<Link to="/howitworks" className="decoration">
								<span className="nav-link sidebar-link">How it works</span>
							</Link>
						</li>
						<li className="nav-item">
							<Link to="/pricing" className="decoration">	
								<span className="nav-link sidebar-link" aria-current="page">Prices</span>
							</Link>
						</li>
						<li className="nav-item">
							<Link to="/testimonials" className="decoration">	
								<span className="nav-link sidebar-link" aria-current="page">Testimonials</span>
							</Link>
						</li>
						<li className="nav-item">
							<Link to="/login" className="decoration">	
								<span className="nav-link sidebar-link text-success" aria-current="page">Login <i class="fa-solid fa-user-plus"></i></span>
							</Link>
						</li>
						{ 
						/* <li className="nav-item">
